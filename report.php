...
$stmt = $pdo->query("SELECT id, rating, voice_note, created_at FROM feedback ORDER BY created_at DESC");
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($feedback['voice_note']): ?>
                                <audio controls>
                                    <source src="<?php echo htmlspecialchars($feedback['voice_note']); ?>" type="audio/wav">
